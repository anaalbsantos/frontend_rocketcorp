...
type Colaborador = {
  id: number;
  name: string;
  role: "Product Owner" | "Desenvolvedor" | "Designer" | "Analista de QA";
...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      // Simulação com dados fixos para desenvolvimento e testes
  ...
  const dataFechamento = new Date(2025, 7, 30);
    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <DashboardStatCard
          ...
          description={`Faltam ${diasRestantes} dias para o fechamento do ciclo, no dia ${dataFechamento.toLocaleDateString(
            "pt-BR"
          )}`}
