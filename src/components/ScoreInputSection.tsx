...
const ScoreInputSection: React.FC<ScoreInputSectionProps> = ({
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col C1200:flex-row gap-4 pt-4 border-b border-gray-200 pb-4 px-6">
            ...
            {status === "Finalizado" && (
              <div className="flex gap-2 justify-end mb-2">
                <button
                  type="button"
                  onClick={onDownload}
                  className="flex items-center gap-1 px-3 py-1.5 rounded-md border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 transition-colors duration-200 text-sm"
                >
                ...
                <button
                  type="button"
                  onClick={onEdit}
                  className="flex items-center gap-1 px-3 py-1.5 rounded-md bg-[#08605F] text-white font-semibold hover:bg-[#064a49] transition-colors duration-200 text-sm"
                >
                  <Edit size={16} /> Editar
                </button>
              </div>
