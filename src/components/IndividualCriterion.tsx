    ...
    <div className="border border-gray-200 rounded-md bg-white">
      ...
      >
        ...
        <div className="flex items-center space-x-4" onClick={(e) => e.stopPropagation()}>
          {!isEditing && (
            <span className={`text-sm ${isMandatory ? "text-black" : "text-gray-400"} hidden xl:inline whitespace-nowrap`}>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            ...
            <div>
              ...
              <input
                type="text"
                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm bg-white text-gray-800"
                placeholder={pesoPlaceholder || "Ex: 20%"}
                value={initialWeight}
                onChange={(e) => onChangeWeight && onChangeWeight(e.target.value)}
                disabled={!isEditing}
              />
            </div>
