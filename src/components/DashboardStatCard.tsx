  ...
  const renderContent = () => {
    switch (type) {
        ...
        return (
          <div className={baseStyle} onClick={onClick}>
            <div className={textoContainer}>
              <p className="font-bold text-black text-lg sm:text-xl mb-5 7">
                {title}
              </p>
              <p
      ...
      case "pendingReviews": {
        return (
          <div className={baseStyle} onClick={onClick}>
            ...
            <div
              className={`${iconeContainer} gap-3 text-3xl sm:text-4xl font-bold ml-4 text-red-600`}
            >
              {icon}
              <span>
                {value !== undefined
        ...
        return (
          ...
          >
            <div className={textoContainer}>
              ...
              <p className="text-white text-sm border-l-4 border-white pl-2 break-words">
                {description}
              </p>
            </div>
            <div
              className={`${iconeContainer} text-3xl sm:text-4xl font-bold ml-4`}
            >
              {icon}
              {value}
            </div>
      ...
      case "prazo": {
        return (
          <div className={baseStyle} onClick={onClick}>
            <div className="flex flex-col flex-grow min-w-0 max-w-full">
              <p className="font-bold text-black text-lg sm:text-xl mb-5">
                {title}
              </p>
              <p className="text-text-muted text-sm border-l-4 border-green-500 pl-2 break-words whitespace-normal">
                {description}
              </p>
            </div>
            <div className="flex-shrink-0 flex items-center justify-center gap-3 text-green-600 font-bold ml-4">
        ...
        return (
          <div className={baseStyle} onClick={onClick}>
            <div className="flex flex-col flex-grow min-w-0 max-w-full">
              ...
              <p className="text-text-muted text-sm border-l-4 border-[#08605f] pl-2 break-words whitespace-normal">
                {description}
              </p>
            </div>

            <div className="flex-shrink-0 ml-4 relative w-20 h-20">
              <svg
                viewBox="0 0 100 100"
      ...
      case "growth": {
        ...
        return (
          <div className={`${baseStyle} bg-white`} onClick={onClick}>
            <div className={textoContainer}>
              <p className="font-bold text-black text-lg sm:text-xl mb-5 truncate">
                {title}
              </p>
              <p
                className="text-text-muted text-sm border-l-4 pl-2 break-words"
